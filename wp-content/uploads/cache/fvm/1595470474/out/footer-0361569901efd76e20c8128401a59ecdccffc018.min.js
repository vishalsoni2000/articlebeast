/* https://articlebeast.online/wp-content/themes/articlebeast/js/slick.min.js */
try{
/* info: https://articlebeast.online/wp-content/themes/articlebeast/js/slick.min.js */
/*
     _ _      _       _
 ___| (_) ___| | __  (_)___
/ __| | |/ __| |/ /  | / __|
...
/* https://articlebeast.online/wp-content/themes/articlebeast/js/jquery.matchheight.min.js */
try{
/* info: https://articlebeast.online/wp-content/themes/articlebeast/js/jquery.matchheight.min.js */
/*
...
/* https://articlebeast.online/wp-content/themes/articlebeast/js/general.js */
try{
/* info: https://articlebeast.online/wp-content/themes/articlebeast/js/general.js */
$headerHeight='';$headerHeight='';$headerHeightscroll='';jQuery(document).ready(function($){$('.wpuf-dashboard-content table td').each(function(){var pub_text=$(this).text();if($(this).text()=='Publish'){$(this).text('Published')}});if((screen.width<992&&screen.height<480)||(screen.width<480&&screen.height<992)){$(".navbar-toggle").click(function(){if($(this).hasClass("active")){$(this).removeClass("active");$('.mobile_menu').animate({'right':'-100%'},500)}else{$(this).addClass("active");$('.mobile_menu').animate({'right':'0'},500)}});$(".mobile_menu ul li").find("ul").parents("li").prepend("<span></span>");$(".mobile_menu ul li ul").addClass("first-sub");$(".mobile_menu ul li ul").prev().prev("span").addClass("first-em");$(".mobile_menu ul li ul ul").removeClass("first-sub");$(".mobile_menu ul li ul ul").addClass("second-sub");$(".mobile_menu ul li ul ul").prev().prev("span").addClass("second-em");$(".mobile_menu ul li ul ul").prev().prev("span").removeClass("first-em");$(".mobile_menu ul li span.first-em").click(function(e){$(".mobile_menu ul li span.first-em").removeClass('active');$(".mobile_menu ul li span.second-em").removeClass('active');if($(this).parent("li").hasClass("active")){$(this).parent("li").removeClass("active");$(this).next().next("ul.first-sub").slideUp();$(".mobile_menu ul li ul.second-sub li").removeClass("active");$(".mobile_menu ul li ul.second-sub").slideUp()}else{$(this).addClass('active');$(".mobile_menu ul li").removeClass("active");$(this).parent("li").addClass("active");$(".mobile_menu ul li ul.first-sub").slideUp();$(this).next().next("ul.first-sub").slideDown();$(".mobile_menu ul li ul.second-sub li").removeClass("active");$(".mobile_menu ul li ul.second-sub").slideUp()}});$(".mobile_menu ul li ul.first-sub li span.second-em").click(function(e){$(".mobile_menu ul li span.second-em").removeClass('active');if($(this).parent("li").hasClass("active")){$(this).parent("li").removeClass("active");$(this).next().next("ul.second-sub").slideUp()}else{$(this).addClass('active');$(".mobile_menu ul li ul li").removeClass("active");$(this).parent("li").addClass("active");$(".mobile_menu ul li ul.second-sub").slideUp();$(this).next().next("ul.second-sub").slideDown()}});$(".close-btn").click(function(){$('.mobile_menu').animate({'right':'-100%'},500);$(" .navbar-toggle").removeClass("active")})}
if(typeof Marionette!=='undefined'){new(Marionette.Object.extend({initialize:function(){this.listenTo(Backbone.Radio.channel('pikaday'),'init',this.modifyDatepicker)},modifyDatepicker:function(dateObject,fieldModel){dateObject.pikaday._o.minDate=moment().subtract(1,'day')}}))}
$('.article-section ul.article-list').slick({infinite:!0,slidesToShow:3,slidesToScroll:1,dots:!1,arrows:!0,autoplay:!0,adaptiveHeight:!0,responsive:[{breakpoint:992,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:640,settings:{slidesToShow:1,slidesToScroll:1}}]});$('.location-therapists-section ul.staff-list').slick({infinite:!0,slidesToShow:2,slidesToScroll:1,dots:!1,arrows:!0,autoplay:!0,adaptiveHeight:!0,nextArrow:'<span class="slick-next"> &#10095; </span>',prevArrow:'<span class="slick-prev"> &#10094; </span>',responsive:[{breakpoint:580,settings:{slidesToShow:1,slidesToScroll:1}}]});jQuery(function(){var current="https://articlebeast.seoweblogistics.com/account/";if(window.location.href==current){jQuery('.wpuf-dashboard-navigation li:first-child a').addClass('active')}else{jQuery('.wpuf-dashboard-navigation li:first-child a').removeClass('active')}});jQuery(function(){var current=window.location.href;jQuery('.wpuf-dashboard-navigation li a').each(function(){var $this=jQuery(this);if($this.attr('href')==current){$this.addClass('active')}})})});jQuery(window).on('load resize ready',function($){setTimeout(function(){$headerHeight=jQuery('header').outerHeight();jQuery('#wrapper').css('padding-top',$headerHeight);jQuery('.banner-section').css('padding-top',$headerHeight)},500);if(jQuery(window).scrollTop()>50){setTimeout(function(){stickyHeader()},500)}});jQuery(window).scroll(function(event){stickyHeader()});function stickyHeader(){var sticky=jQuery('header'),scroll=jQuery(window).scrollTop();if(scroll>=50){sticky.addClass('sticky');$headerHeightscroll=jQuery('header.sticky').outerHeight()}else sticky.removeClass('sticky')}
...
jQuery('.parallax').each(function(index){var imageSrc=jQuery(this).data('image-src')
...
jQuery('.parallax').each(function(index,element){var initY=jQuery(this).offset().top
var height=jQuery(this).height()
...
/* https://articlebeast.online/wp-content/themes/articlebeast/js/parallax.min.js */
try{
/* info: https://articlebeast.online/wp-content/themes/articlebeast/js/parallax.min.js */
/*!
...
/* https://articlebeast.online/wp-content/themes/articlebeast/assets/js/select2.min.js */
try{
/* info: https://articlebeast.online/wp-content/themes/articlebeast/assets/js/select2.min.js */
...
/* https://articlebeast.online/wp-includes/js/wp-embed.min.js */
try{
/* info: https://articlebeast.online/wp-includes/js/wp-embed.min.js */

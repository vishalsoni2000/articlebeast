...
class SignalHandler
{
    ...
    {
        if (!\extension_loaded('pcntl') || !\function_exists('NF_FU_VENDOR\\pcntl_signal')) {
            return $this;
        }
        if ($callPrevious) {
        ...
        if (\function_exists('NF_FU_VENDOR\\pcntl_async_signals') && $async !== null) {
    ...
    public function handleSignal($signo, array $siginfo = null)
    {
        ...
        if ($this->previousSignalHandler[$signo] === \true || $this->previousSignalHandler[$signo] === SIG_DFL) {
            if (\extension_loaded('pcntl') && \function_exists('NF_FU_VENDOR\\pcntl_signal') && \function_exists('NF_FU_VENDOR\\pcntl_sigprocmask') && \function_exists('NF_FU_VENDOR\\pcntl_signal_dispatch') && \extension_loaded('posix') && \function_exists('posix_getpid') && \function_exists('posix_kill')) {
